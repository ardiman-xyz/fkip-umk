  ...
  <div class="card-body">
    ...
    <div class="row">
       <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12 ">
            ...
            <input type="text" class="form-control mb-2" placeholder="judul.." name="judul" value="<?= $video->judul ?>">
        ...
        <div class="col-md-4">
                ...
                <select name="posisi" class="form-control">
                    ...
                    <option value="video" <?php if($video->posisi =="video"){echo"selected";} ?>>Video Galeri</option>
     ...
     <div class="row mb-2 mt-2">
            <div class="col-md-8">
                ...
                <div class="form-group input-group">
                    ...
                    <input name="video" type="text" class="form-control" placeholder="masukkan kode terakhir yaoutube setalah =..." value="<?= $video->video ?>">
                </div>   
            ...
            <div class="col-md-4">
                ...
                <select name="status" class="form-control">
                    ...
                    <option value="no publish" <?php if($video->status =="no publish"){echo"selected";} ?>>No Publish</option>
                    <option value="pending" <?php if($video->status =="pending"){echo"selected";} ?>>Pending</option>
                </select>
        ...
        <div class="col-md-12">
                ...
                <textarea class="form-control" name="keterangan" rows="3"><?= $video->keterangan; ?></textarea>
