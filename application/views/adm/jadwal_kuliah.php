         ...
         <div class="post-thumb">
            <div class="post-content">
              ...
              <div class="alert alert-info">
                silahkan download Jadwal Kuliah, link dibawah ini
              </div>
              <ul>
                <p><?= $pendidikan->ket_jadwal_kuliah ?></p>
                <li><a target="_blank" href="<?= base_url('site/adm/download/'.$pendidikan->jadwal_kuliah_genap) ?>" title="Kurikulum">Download Jadwal kuliah semester genap</a></li>
                <li><a target="_blank" href="<?= base_url('site/adm/download/'.$pendidikan->jadwal_kuliah_ganjil) ?>" title="Kurikulum">Download Jadwal kuliah semester ganjil</a></li>
              </ul>
            </div>
         </div>
        </div>
