            ...
            <div class="post-content">
              ...
              <div class="row">
                <div class="col-md-12" style="margin-bottom: 20px">
                 <iframe width="805" height="453" src="https://www.youtube.com/embed/UQLH5lO9Pcw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                  <p><b>Fasilitas ADM</b></p>
                </div>
               <?php foreach ($fasilitas as $f): ?>
                  <div class="col-md-3">
                    <div class="card" style="margin: 5px">
                      <a href="<?= base_url('assets/adm/file_upload/'.$f->foto) ?>">
                        <img class="card-img-top" src="<?= base_url('assets/adm/file_upload/'.$f->foto) ?>" alt="Card image cap"  width="100%" height="150">
                      </a>
                      <div class="card-body">
                        <p><?= $f->deskripsi ?></p>
                    </div>
