         ...
         <div class="post-thumb">
            <div class="post-content">
              ...
              <div class="alert alert-info">
                silahkan download kurikulum, link dibawah ini
              </div>
              <ul>
                <p><?= $pendidikan->ket_kurikulum ?></p>
                <li><a target="_blank" href="<?= base_url('site/adm/download/'.$pendidikan->kurikulum) ?>" title="Kurikulum">Download file</a></li>
              </ul>
            </div>
         </div>
        </div>
