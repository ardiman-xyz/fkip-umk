         ...
         <div class="post-thumb">
            <div class="post-content">
              ...
              <div class="alert alert-info">
                silahkan download Akreditasi, link dibawah ini
              </div>
              <ul>
                <li><a target="_blank" href="<?= base_url('site/adm/download/'.$akreditasi) ?>" title="akreditasi">Download Akreditasi (pdf)</a></li>
              </ul>
            </div>
         </div>
        </div>
