        ...
        <div class="card-body">
         <div class="post-thumb">
            <div class="post-content" >
             <div align="center">
                <img src="<?= base_url('assets/images/') ?>person_4.jpg" alt="img" width="100;" style="margin-right: 10px; margin-bottom: 20px">
                <p><b>SAMBUTAN KETUA PRODI ADMINISTRASI PENDIDIKAN</b></p>
                <p><b>FAKULTAS KEGURUAN DAN ILMU PENDIDIKAN</b></p>
                <p style="color: #94908f"><b>Junaidin, S.Pd., M.Pd.</b></p>
             </div>
              <p><?= $sambutan ?></p>
            </div>
         </div>
