         ...
         <div class="post-thumb">
            <div class="post-content">
              ...
              <div class="alert alert-info">
                silahkan download Kalender akademik, link dibawah ini
              </div>
              <ul>
                <p><?= $pendidikan->ket_kalender_akademik ?></p>
                <li><a target="_blank" href="<?= base_url('site/adm/download/'.$pendidikan->kalender_akademik) ?>" title="Kurikulum">Download file</a></li>
              </ul>
            </div>
         </div>
        </div>
