        ...
        <div class="footer-inner">
          <div class="footer-content">
            <span class="bigger-120">
              ...
              Universitas Muhammadiyah Kendari &copy; 2020
            </span>
...
<![endif]-->
    ...
    <script type="text/javascript" src="<?= base_url('assets/js/') ?>ace.min.js"></script>
    <script src="<?= base_url('assets/back-end/assets/js/') ?>sweatalert.js" type="text/javascript"></script>
