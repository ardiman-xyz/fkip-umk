...
<div class="row justy-content-center">
   ...
   <a href="<?= base_url('mahasiswa/surat') ?>" class="btn btn-sm btn-danger" style="border-radius: 1px;">&larr; Kembali</a>
              ...
              <form method="" action="">
                ...
                <fieldset>
                  <label>Pilih jenis surat</label>
                        ...
                        <option value="4">SK Belum Menerima Beasiswa</option>
                        <option value="5">Formulir Minat Bakat</option>
                      </select>
...
<script>
     $(document).ready(function(){
        ...
        $.ajax({
          type: 'post',
          url: '<?= base_url("mahasiswa/surat/form_surat/") ?>' + pilihan,
          cache: false,
