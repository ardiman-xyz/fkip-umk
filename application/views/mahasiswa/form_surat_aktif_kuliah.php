  ...
  <div class="alert alert-info"><i class="fa fa-info-circle"></i><strong> Silahkan isi formulir dengan data yang falid!!</strong></div>
    ...
    <form class="" method="" action="" id="aktifForm">
     <div class="table-responsive">
       ...
       <tr>
         <td>Alamat </td><td>  <input type="text" name="alamat" id="alamat" class="col-md-8 col-xs-12"></td>
       </tr>
     </table>
     </div>
...
<table class="table">
     <tr>
         <td>Nama Orang Tua</td><td>  <input type="text" name="nama_ortu" id="nama_ortu" class="col-md-8  col-xs-12"></td>
       </tr>
       <tr>
         <td>NIP/NRP </td><td>  <input type="text" name="nip" id="nip" class="col-md-5 col-xs-12"></td>
       </tr>
       <tr>
         <td>Pangkat/Golongan </td><td>  <input type="text" name="pangkat" id="pangkat" class="col-md-4  col-xs-12"></td>
       </tr>
        <tr>
         <td>Jabatan/Pekerjaan </td><td>  <input type="text" name="jabatan" id="jabatan" class="col-md-4  col-xs-12"></td>
       </tr>
        <tr>
         <td>Intansi Kantor </td><td>  <input type="text" name="instansi" id="instansi" class="col-md-8  col-xs-12"></td>
       </tr>
        <tr>
         <td>Alamat</td><td>  <input type="text" name="alamat_ortu" id="alamat_ortu" class="col-md-8  col-xs-12"></td>
       </tr>
     </table>
    </form>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#btnCuti').click(function(){
      ...
      const btnCuti = $('#btnCuti').text('Menyimpan...');
      btnCuti.attr('disabled', true);

      $.ajax({
        type: 'post',
        url: '<?= base_url("mahasiswa/surat/simpan_surat_aktifkuliah") ?>',
        data: data,
        dataType: 'json',
        success: function(data){
          if (data.status = true) {
            ...
            $('#aktifForm')[0].reset();
            btnCuti.attr('disabled', false);
            btnCuti.html(`<i class="glyphicon glyphicon-ok"></i> Kirim`);
