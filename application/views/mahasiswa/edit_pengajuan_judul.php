      ...
      <div class="widget-box">
        ...
        <div class="widget-body">
          <div class="widget-main">
            <form class="form-horizontal form-label-left" method="post" action="<?= base_url('mahasiswa/registrasi/update_pengajuan') ?>" id="edit_pengajuan" enctype="multipart/form-data">
              <input type="hidden" name="id" value="<?= $data->id ?>">
                   <div class="table-responsive">
                     ...
                     <tr>
                       ...
                       <option value="">--Pilih Dosen--</option>
                        <?php foreach($dosen as $ds) : ?>
                            <option value="<?= $ds->NIDN ?>" <?= ($ds->NIDN == $data->id_pembimbing1 ? 'selected' : '')  ?>><?= $ds->nama_dosen ?></option>
                        <?php endforeach ?>
                       </select>
                       </td>
                     </tr>
                     ...
                     <tr>
                       <td>Judul yang disarankan</td><td>  <textarea name="judul" id="judul" cols="50" rows="4" placeholder="masukkan judul yang disarankan...." class="form-control col-md-4 col-xs-8"><?= $data->judul ?></textarea></td>
                     </tr>
                     <tr>
