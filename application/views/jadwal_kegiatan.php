        ...
        <div class="card-body">
         <div class="post-thumb">
            <div class="post-content">
              <p>jadwal kegiatan KKA/MAGANG tahun <b><?= $jadwal->tahun ?></b> semester <b><?= cari_status_akademik(); ?></b> akan di buka pada tanggal <b><?= tgl_jadwal($jadwal->tgl_start) ?></b> dan di tutup pada tanggal <b><?= tgl_jadwal($jadwal->tgl_end) ?></b></p>
            </div>
         </div>
        </div>
      </div>
