        ...
        <div class="card-body">
         <div class="post-thumb">
            <div class="post-content">
                <table class="table table-hover table-sm table-striped table-bordered" id="example1">
                	<thead>
                		<tr>
                    ...
                    $nama_prodi = $this->prodi->nama_jurusan($dsn->id_prodi);
                    ?>
                			<tr>
                				<td align="center"><?= $no++ ?></td>
                        <td class="text-center"><?= $dsn->NIDN ?></td>
                				<td>
                					<a href="<?= base_url('home/detail_dosen/'.$dsn->id_dosen) ?>"><?= $dsn->nama_dosen ?></a>
                				</td>
