                  ...
                  <tbody>
                    <?php foreach ($skripsi as $key => $s): ?>
                    	<tr>
                    		...
                    		<td><?= $s->judul ?></td>
                    		<td>
                    			<a href="<?= base_url("assets/upload/skripsi/".$s->skripsi) ?>" target="_blank" title="File skripsi"><i class="fa fa-file" style="color:blue"></i> File</a>
                    		</td>
                    	</tr>
                    <?php endforeach ?>
                  </tbody>
