              ...
              <div class="row">
               <?php foreach ($tendik as $t): ?>
                    <div class="col-md-2" style="margin: 10px; border-right: 1px black solid">
                      <?php if ($t->foto === ''): ?>
                      <img src="<?= base_url('assets/adm/img/') ?>no-img.jpg" alt="<?= $t->nama ?>" class="img" style="border-radius: 50%" width="100">
                      <?php else: ?>
                        <img src="<?= base_url('assets/upload/tendik/'.$t->foto) ?>" alt="<?= $t->nama ?>" class="img" style="border-radius: 50%" width="100">
                      <?php endif ?>
                    </div>
                    <div class="col-md-9">
                      <h6><?= $t->nama ?></h6>
