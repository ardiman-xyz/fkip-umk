...
<div class="container">
  <div class="row mb-2">
    <div class="col-md-9 justy-content-center">
        ...
        <div class="card-body">
         <div class="post-thumb">
            <div class="post-content">
              ...
              <!--<img src="<?= base_url('assets/upload/') ?>kalender_akademik.jpeg" alt="Kalender Akademik" width="100%">-->
               <a href="<?= base_url('assets/upload/') ?>Kalender_Akademik_2020.pdf" title="">Kalender akademik 2020</a>
     ...
     <div class="col-md-3 mt-2" style="margin-top: 2px">
