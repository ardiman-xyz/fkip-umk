<div class="container" style="margin-top: 20px">
	...
	<a align="center" href="<?= base_url('tendik/pendaftar_ujian') ?>" class="btn btn-sm btn-danger">&larr; Kembali</a>
	...
	<div class="col-md-5">
	    ...
	    <div class="card-body">
	    	...
	    	<hr>
	    	<?php if ($data->turnitin === null): ?>
	    	<p><b>Bukti Turnitin</b></p>
	    	<p>Data Belum di upload</p>
            <?php else: ?>
            <p><b>Bukti Turnitin</b></p>
	    	<a href="<?= base_url('assets/upload/image/'.$data->turnitin) ?>" data-lightbox="mygallery"><img class="img img-thumbnail img-responsive" src="<?= base_url('assets/upload/image/'.$data->turnitin) ?>" width="200"></a>
	    	<hr>
            <?php endif ?>
	    </div>
	</div>
