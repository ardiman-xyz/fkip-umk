...
<div class="row justy-content-center">
    ...
    <?php endif ?>
       ...
       <div class="card">
           <div class="card-body">
           	<a href="<?= base_url('tendik/tambah_fasilitas') ?>" class="btn btn-sm btn-primary">Tambah fasilitas</a>
               <table class="table table-stripped" id="dynamic-table">
               	...
               	<tbody>
               		<?php $no =1; foreach ($fasilitas as $f): ?>
               			<tr>
	               			<td><?= $no++ ?></td>
	               			<td><img src="<?= base_url('assets/adm/file_upload/'.$f->foto) ?>" alt="img fasilitas" width="100"></td>
	               			<td><?= $f->deskripsi ?></td>
                      <td>
