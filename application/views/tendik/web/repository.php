...
<div class="row justy-content-center">
    ...
    <?php endif ?>
       ...
       <div class="card">
           <div class="card-body">
           	<a href="<?= base_url('tendik/tambah_repo') ?>" class="btn btn-sm btn-primary">Tambah Repo</a>
               	...
               	<tbody>
               		<?php $no =1; foreach ($file as $f): ?>
               			<tr>
	               			...
	               			<td><?= $f->nama_file ?></td>
                      <td>
                        <a href="<?= base_url('assets/adm/file_upload/'.$f->file) ?>" target="_blank" title="<?= $f->nama_file ?>"><?= $f->nama_file ?></a></td>
                      <td>
