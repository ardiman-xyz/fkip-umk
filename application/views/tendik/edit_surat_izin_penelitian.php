    ...
    <div class="col-md-10">
        ...
        <div class="widget-body">
          <div class="widget-main">
            <form class="form-horizontal form-label-left" method="post" action="<?= base_url('tendik/update_surat_izin_penelitian/'.$data->id) ?>" id="myCutiForm">
			      ...
			      <div class="form-group">
			        <label class="control-label col-md-3" for="first-name">Judul penelitian</label>
			        <div class="col-md-9">
			          <textarea name="judul" class="form-control" required rows="3"><?= $data->judul_penelitian ?></textarea>
			        </div>
			      </div>

                  <p class="mb-0 text-center">
                  	<a href="<?= base_url('tendik/surat_pengajuan_judul') ?>" title="Batal" class="btn btn-danger btn-md">Batal</a>
                    <button style="border-radius: 1px" class="btn btn-primary btn-md" type="submit">Update surat izin penelitian</button>
                  </p>
            </form>
          </div>
        </div>
