            ...
            <div class="col-md-10">
              ...
              <div class="card">
                ...
                <div class="card-body">
                 ...
                 <form action="<?= base_url('dosen/update_penawaran') ?>" method="get" accept-charset="utf-8" id="form_penawaran">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                      <select name="semester" class="form-control">
                        <option value="genap" <?= $data->semester === 'genap' ? 'seelcted' : '' ?>>Genap</option>
                        <option value="ganjil" <?= $data->semester === 'gangil' ? 'seelcted' : '' ?>>Ganjil</option>
                      </select>
                    </div>
                    <div class="col-sm-2">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                      <input type="text" name="ip_smt_lalu" class="form-control" id="inputEmail3" placeholder="masukkkan ip semester lalu">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-3 col-form-label">Jumlah sks</label>
                    <div class="col-sm-3">
                      <input type="text" name="jumlah_sks" class="form-control" id="inputEmail3" placeholder="masukkkan jumlah sks">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-3 col-form-label">Matakuliah yang diprogram</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control mb-1" name="nama_matakuliah[]" id="inputEmail3" placeholder="Masukkan nama matakuliah">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <textarea name="komenter_pa" class="form-control" rows="4" placeholder="masukkan komentar"></textarea>
                    </div>
                  </div>
